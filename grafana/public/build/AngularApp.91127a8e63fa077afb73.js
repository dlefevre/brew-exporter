(self.webpackChunkgrafana=self.webpackChunkgrafana||[]).push([[4704],{85934:l=>{var a=`<div ng-transclude class="gf-form-query-content"></div>

`,t=a,e="public/app/angular/panel/partials/query_editor_row.html";window.angular.module("ng").run(["$templateCache",function(n){n.put(e,t)}]),l.exports=e},9958:l=>{var a=`<datasource-http-settings-next on-change="onChange" datasourceconfig="current" showaccessoptions="showAccessOption" defaulturl="suggestUrl" showforwardoauthidentityoption="showForwardOAuthIdentityOption">
`,t=a,e="public/app/angular/partials/http_settings_next.html";window.angular.module("ng").run(["$templateCache",function(n){n.put(e,t)}]),l.exports=e},17075:l=>{var a=`<div class="gf-form-group">
  <div class="gf-form">
...
`,t=a,e="public/app/angular/partials/tls_auth_settings.html";window.angular.module("ng").run(["$templateCache",function(n){n.put(e,t)}]),l.exports=e},61491:l=>{var a=`<page-header model="ctrl.navModel"></page-header>
...
<footer>
`,t=a,e="public/app/features/admin/partials/admin_home.html";window.angular.module("ng").run(["$templateCache",function(n){n.put(e,t)}]),l.exports=e},8322:l=>{var a=`<page-header model="navModel"></page-header>
...
<footer>
`,t=a,e="public/app/features/admin/partials/edit_org.html";window.angular.module("ng").run(["$templateCache",function(n){n.put(e,t)}]),l.exports=e},24956:l=>{var a=`<page-header model="ctrl.navModel"></page-header>
...
`,t=a,e="public/app/features/admin/partials/stats.html";window.angular.module("ng").run(["$templateCache",function(n){n.put(e,t)}]),l.exports=e},43997:l=>{var a=`<page-header model="ctrl.navModel"></page-header>
...
`,t=a,e="public/app/features/admin/partials/styleguide.html";window.angular.module("ng").run(["$templateCache",function(n){n.put(e,t)}]),l.exports=e},83827:l=>{var a=`<div ng-if="ctrl.panel.alert">
...
`,t=a,e="public/app/features/alerting/partials/alert_tab.html";window.angular.module("ng").run(["$templateCache",function(n){n.put(e,t)}]),l.exports=e},1974:l=>{var a=`
...
`,t=a,e="public/app/features/annotations/partials/event_editor.html";window.angular.module("ng").run(["$templateCache",function(n){n.put(e,t)}]),l.exports=e},88153:l=>{var a=`<div class="modal-body" ng-cloak>
...
`,t=a,e="public/app/partials/confirm_modal.html";window.angular.module("ng").run(["$templateCache",function(n){n.put(e,t)}]),l.exports=e},96519:l=>{var a=`<div class="modal-header">
...
</div>`,t=a,e="public/app/partials/modal.html";window.angular.module("ng").run(["$templateCache",function(n){n.put(e,t)}]),l.exports=e},56304:l=>{var a=`<page-header model="navModel"></page-header>
...
<footer>
`,t=a,e="public/app/partials/reset_password.html";window.angular.module("ng").run(["$templateCache",function(n){n.put(e,t)}]),l.exports=e},2426:l=>{var a=`<page-header model="navModel"></page-header>
...
<footer>
`,t=a,e="public/app/partials/signup_invited.html";window.angular.module("ng").run(["$templateCache",function(n){n.put(e,t)}]),l.exports=e},52100:l=>{var a=`<div class="editor-row">
...
`,t=a,e="public/app/plugins/panel/graph/axes_editor.html";window.angular.module("ng").run(["$templateCache",function(n){n.put(e,t)}]),l.exports=e},27527:l=>{var a=`<div class="gf-form-group">
...
`,t=a,e="public/app/plugins/panel/graph/tab_display.html";window.angular.module("ng").run(["$templateCache",function(n){n.put(e,t)}]),l.exports=e},48667:l=>{var a=`<div class="editor-row">
...
`,t=a,e="public/app/plugins/panel/graph/tab_legend.html";window.angular.module("ng").run(["$templateCache",function(n){n.put(e,t)}]),l.exports=e},28669:l=>{var a=`<div class="graph-series-override" ng-repeat="override in ctrl.panel.seriesOverrides" ng-controller="SeriesOverridesCtrl">
  <div class="gf-form">
...
`,t=a,e="public/app/plugins/panel/graph/tab_series_overrides.html";window.angular.module("ng").run(["$templateCache",function(n){n.put(e,t)}]),l.exports=e},36190:l=>{var a=`<graph-threshold-form panel-ctrl="ctrl"></graph-threshold-form>
`,t=a,e="public/app/plugins/panel/graph/tab_thresholds.html";window.angular.module("ng").run(["$templateCache",function(n){n.put(e,t)}]),l.exports=e},13210:l=>{var a=`<graph-time-region-form panel-ctrl="ctrl"></graph-time-region-form>
`,t=a,e="public/app/plugins/panel/graph/tab_time_regions.html";window.angular.module("ng").run(["$templateCache",function(n){n.put(e,t)}]),l.exports=e},23509:l=>{var a=`<div class="gf-form-group">
...
`,t=a,e="public/app/plugins/panel/graph/thresholds_form.html";window.angular.module("ng").run(["$templateCache",function(n){n.put(e,t)}]),l.exports=e},15752:l=>{var a=`<div class="gf-form-group">
...
`,t=a,e="public/app/plugins/panel/graph/time_regions_form.html";window.angular.module("ng").run(["$templateCache",function(n){n.put(e,t)}]),l.exports=e},54050:l=>{var a=`<div class="editor-row">
  <div class="section gf-form-group">
...
`,t=a,e="public/app/plugins/panel/heatmap/partials/axes_editor.html";window.angular.module("ng").run(["$templateCache",function(n){n.put(e,t)}]),l.exports=e},76307:l=>{var a=`<div class="editor-row">
  <div class="section gf-form-group">
...
`,t=a,e="public/app/plugins/panel/heatmap/partials/display_editor.html";window.angular.module("ng").run(["$templateCache",function(n){n.put(e,t)}]),l.exports=e},99187:l=>{var a=`<div class="edit-tab-content" ng-repeat="style in editor.panel.styles">
  <div class="gf-form-group">
    <h5 class="section-heading">Options</h5>
    <div class="gf-form-inline">
      <div class="gf-form gf-form--grow">
...
`,t=a,e="public/app/plugins/panel/table-old/column_options.html";window.angular.module("ng").run(["$templateCache",function(n){n.put(e,t)}]),l.exports=e},2393:l=>{var a=`<div class="gf-form-group">
  <div class="grafana-info-box">
...
`,t=a,e="public/app/plugins/panel/table-old/editor.html";window.angular.module("ng").run(["$templateCache",function(n){n.put(e,t)}]),l.exports=e},25031:l=>{var a=`<div class="table-panel-container">
...
`,t=a,e="public/app/plugins/panel/table-old/module.html";window.angular.module("ng").run(["$templateCache",function(n){n.put(e,t)}]),l.exports=e},11461:(l,a,t)=>{var e={"./angular/panel/partials/query_editor_row.html":85934,"./angular/partials/http_settings_next.html":9958,"./angular/partials/tls_auth_settings.html":17075,"./features/admin/partials/admin_home.html":61491,"./features/admin/partials/edit_org.html":8322,"./features/admin/partials/stats.html":24956,"./features/admin/partials/styleguide.html":43997,"./features/alerting/partials/alert_tab.html":83827,"./features/annotations/partials/event_editor.html":1974,"./partials/confirm_modal.html":88153,"./partials/modal.html":96519,"./partials/reset_password.html":56304,"./partials/signup_invited.html":2426,"./plugins/panel/graph/axes_editor.html":52100,"./plugins/panel/graph/tab_display.html":27527,"./plugins/panel/graph/tab_legend.html":48667,"./plugins/panel/graph/tab_series_overrides.html":28669,"./plugins/panel/graph/tab_thresholds.html":36190,"./plugins/panel/graph/tab_time_regions.html":13210,"./plugins/panel/graph/thresholds_form.html":23509,"./plugins/panel/graph/time_regions_form.html":15752,"./plugins/panel/heatmap/partials/axes_editor.html":54050,"./plugins/panel/heatmap/partials/display_editor.html":76307,"./plugins/panel/table-old/column_options.html":99187,"./plugins/panel/table-old/editor.html":2393,"./plugins/panel/table-old/module.html":25031,"app/angular/panel/partials/query_editor_row.html":85934,"app/angular/partials/http_settings_next.html":9958,"app/angular/partials/tls_auth_settings.html":17075,"app/features/admin/partials/admin_home.html":61491,"app/features/admin/partials/edit_org.html":8322,"app/features/admin/partials/stats.html":24956,"app/features/admin/partials/styleguide.html":43997,"app/features/alerting/partials/alert_tab.html":83827,"app/features/annotations/partials/event_editor.html":1974,"app/partials/confirm_modal.html":88153,"app/partials/modal.html":96519,"app/partials/reset_password.html":56304,"app/partials/signup_invited.html":2426,"app/plugins/panel/graph/axes_editor.html":52100,"app/plugins/panel/graph/tab_display.html":27527,"app/plugins/panel/graph/tab_legend.html":48667,"app/plugins/panel/graph/tab_series_overrides.html":28669,"app/plugins/panel/graph/tab_thresholds.html":36190,"app/plugins/panel/graph/tab_time_regions.html":13210,"app/plugins/panel/graph/thresholds_form.html":23509,"app/plugins/panel/graph/time_regions_form.html":15752,"app/plugins/panel/heatmap/partials/axes_editor.html":54050,"app/plugins/panel/heatmap/partials/display_editor.html":76307,"app/plugins/panel/table-old/column_options.html":99187,"app/plugins/panel/table-old/editor.html":2393,"app/plugins/panel/table-old/module.html":25031};function n(s){var r=o(s);return t(r)}function o(s){if(!t.o(e,s)){var r=new Error("Cannot find module '"+s+"'");throw r.code="MODULE_NOT_FOUND",r}return e[s]}n.keys=function(){return Object.keys(e)},n.resolve=o,l.exports=n,n.id=11461}}]);

//# sourceMappingURL=AngularApp.91127a8e63fa077afb73.js.map